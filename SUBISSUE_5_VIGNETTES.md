...
release-quality standards **Priority:** Medium **Status:** Vignettes
Exist, Enhancement Opportunities **Assignee:** TBD **Estimated Effort:**
12-20 hours

## Objective

Enhance existing vignettes and add user-facing usage examples to improve
package usability and adoption.

## Background

Two vignettes already exist (`sobol.Rmd` and `sobol-sequences.Rmd`).
This task focuses on enhancing them and adding practical examples.
...
Basic usage (covered in sobol.Rmd)

Incremental generation (covered)

Skip functionality (covered)

Batch generation (covered)
...
Consider creating an “Articles” section on the pkgdown site separate
from vignettes for longer-form content that doesn’t need to ship with
the package.
